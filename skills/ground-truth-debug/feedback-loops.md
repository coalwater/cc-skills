...
A fast, deterministic, agent-runnable pass/fail signal for the bug *is* ground truth. Build the right one and the bug is 90% fixed. This is the catalog and the sharpening rules.
